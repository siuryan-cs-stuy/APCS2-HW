// Team aMAZEing -- Mansour Elsharawy & Ryan Siu
// APCS2 pd5
 ...
 *  1. If at the exit, then the solution has been found.
 *  2. Find a path that has not yet been traversed and move there. Repeat 1.
 *  3. Otherwise, if there's a dead end, then go back to the last path that has
 *     an alternate route, and repeat 2.
 ***/
...
class MazeSolver 
{
	...
	else if ((maze[x][y] == HERO) || (maze[x][y] == VISITED_PATH)) {
	    return;
	}
	//recursive reduction
	else {
